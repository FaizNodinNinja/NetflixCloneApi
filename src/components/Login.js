  ...
  return (
    <div className="login">
      <div className="holder">
        ...
        {isUserExist && (
          <p className="text-dander">User does not exist | Go to Sign Up </p>
        )}
        {isEmailUsed && (
          <p className="text-dander">email already in exist | Go to Sign In </p>
        )}
